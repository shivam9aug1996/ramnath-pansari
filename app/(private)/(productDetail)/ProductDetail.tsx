...
import { getCategoriesFromPath } from "@/utils/categoryPath";
import ProductCategoryBreadcrumbs from "./ProductCategoryBreadcrumbs";
...
const ProductDetail = ({ id, extraData }: { id: string; extraData: any }) => {
  ...
  const breadcrumbs = useMemo(
    ...
    [categoriesData?.categories, data?.product?.categoryPath],
  );
                ...
                {isLoading ? (
                  ...
                  <>
                    <View style={contentStyles.textContainer}>
                      ...
                      <ThemedText
                        style={contentStyles.productPrice}
                        type="title"
                      >
                        {`₹ ${discountedPrice}`}
                      </ThemedText>
